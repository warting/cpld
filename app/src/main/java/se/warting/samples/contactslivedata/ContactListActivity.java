...
public class ContactListActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ContactsLiveData cld = new ContactsLiveData(this);
        cld.observe(this, new Observer<ArrayList<DummyContent.DummyItem>>() {
            @Override
            public void onChanged(@Nullable ArrayList<DummyContent.DummyItem> dummyItems) {
                Log.d(TAG, dummyItems.toString());
            }
        });
